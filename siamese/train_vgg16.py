...
def main():
    ...
    # ======== 3. Khởi tạo mô hình ========
    model = VGG16Backbone().to(DEVICE)
    criterion = ContrastiveLoss(margin=MARGIN)
    optimizer = Adam(model.parameters(), lr=LEARNING_RATE)

    best_val_loss = float('inf')
    epochs_no_improve = 0
    model_save_path = "weights/vgg16_best_fit.pt"
    ...
    graph(train_losses, val_losses, accuracies, precisions, recalls, save_path="outputs/vgg16_training_plot.png")
