...
def plot_metrics(train_losses, val_losses, train_accuracies, val_accuracies):
    ...
    plt.savefig("trainplot_ecavgg19.png")  # You can change the file name and format (e.g., .png, .jpg, .pdf)
...
if __name__ == "__main__":
    ...
    from utils.model import ECAVGG19
    model = ECAVGG19(
    ...
    for epoch in range(100):
        ...
        if val_acc > max_acc:
            ...
            folder_path = 'checkpoints_vgg19eca'  # Define the folder name
            ...
            # path file to save
            file_path = os.path.join(folder_path, f'ecavgg19_epoch_{epoch}_acc_{val_acc:.4f}.pt')
