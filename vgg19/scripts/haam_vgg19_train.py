...
def plot_metrics(train_losses, val_losses, train_accuracies, val_accuracies):
    ...
    plt.savefig("trainplot_haam_vgg19.png")  # You can change the file name and format (e.g., .png, .jpg, .pdf)
...
if __name__ == "__main__":
    ...
    from utils.HAMM import HAAMVGG19
    model = HAAMVGG19(
    ...
    for epoch in range(100):
        ...
        if val_acc > max_acc:
            ...
            folder_path = 'checkpoints_haam_vgg19'  # Define the folder name
            ...
            # path file to save
            file_path = os.path.join(folder_path, f'haam_vgg19_epoch_{epoch}_acc_{val_acc:.4f}.pt')
