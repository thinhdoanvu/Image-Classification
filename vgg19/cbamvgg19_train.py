...
def plot_metrics(train_losses, val_losses, train_accuracies, val_accuracies):
    ...
    plt.savefig("trainplot_cbamvgg19.png")  # You can change the file name and format (e.g., .png, .jpg, .pdf)
...
if __name__ == "__main__":
    ...
    from utils.model import CBAMVGG19
    model = CBAMVGG19(
    ...
    for epoch in range(100):
        ...
        if val_acc > max_acc:
            ...
            folder_path = 'checkpoints_vgg19cbam'  # Define the folder name
            ...
            # path file to save
            file_path = os.path.join(folder_path, f'cbamvgg19_epoch_{epoch}_acc_{val_acc:.4f}.pt')
