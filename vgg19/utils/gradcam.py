...
def show_gbs(inputs, gb_model, target_index, mask_dic):
    ...
    cv2.imwrite('vgg19_visualize.jpg', deprocess_image(gb))
...
if __name__ == '__main__':
    ...
    from s import *
    model = SEVGG19(num_classes=1)  # VGG19
    grad_cam = GradCam(model=model, blob_name='layer0', target_layer_names=['2'], use_cuda=False)

    img = cv2.imread('E:/thanh/ntu_group/thinh/Image-Classification/garbage/dataset_split/train/trash/Miscellaneous Trash_217.jpg', 1)
