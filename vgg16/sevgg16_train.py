...
if __name__ == "__main__":
    ...
    from utils.model import SEVGG16
    model = SEVGG16(
    ...
    for epoch in range(100):
        ...
        if val_acc > max_acc:
            ...
            folder_path = 'checkpoints_vgg16se'  # Define the folder name
            ...
            # path file to save
            file_path = os.path.join(folder_path, f'sevgg16_epoch_{epoch}_acc_{val_acc:.4f}.pt')
