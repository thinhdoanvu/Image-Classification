...
if __name__ == "__main__":
    ...
    folder_pcheckpoints = 'checkpoints'  # Define the folder name
    file_checkpoints = os.path.join(folder_pcheckpoints,'resnet18_epoch_89_valoss_0.0006.pt')#lay epoch cuoi cung
