...
if __name__ == "__main__":
    ...
    val_dataset = ImageFolder(root='../dataset/valid', transform=transform)
    # Get class names
    ...
    for epoch in range(100):
        ...
        if val_acc > max_acc:
            ...
            torch.save(model.state_dict(), 'cpts4playcards/epoch_' + str(epoch) + '_acc_{0:.4f}'.format(max_acc) + '.pt')
            max_acc = val_acc
