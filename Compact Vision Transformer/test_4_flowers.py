...
def test_model():
    ...
    folder_checkpoint = 'cpts4flowers'  # Define the folder name
    file_checkpoint = os.path.join(folder_checkpoint, 'epoch_60_acc_0.8912.pt')  # lay epoch cuoi cung
