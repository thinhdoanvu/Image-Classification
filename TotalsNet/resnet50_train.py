...
if __name__ == "__main__":
    ...
    import timm
    model = timm.create_model('resnet50', pretrained=True, num_classes=len(class_names)).to(device)
    ...
    best_model_path = "weights/resnet50_best_fit.pt"
    ...
    plot_metrics(
        ...
        train_precisions, val_precisions,
        train_recalls, val_recalls,
        save_path="outputs/resnet50_training_plot.png"
    )
