...
if __name__ == "__main__":
    ...
    import timm
    model = timm.create_model('mobilenetv2_100', pretrained=True, num_classes=len(class_names)).to(device)
    ...
    best_model_path = "weights/mobilenetv2_100_best_fit.pt"
    ...
    plot_metrics(
        ...
        train_precisions, val_precisions,
        train_recalls, val_recalls,
        save_path="outputs/mobilenetv2_100_training_plot.png"
    )
