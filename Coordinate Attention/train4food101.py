...
if __name__ == "__main__":
    ...
    train_dataset = ImageFolder(root='../food-101/train', transform=transform)
    val_dataset = ImageFolder(root='../food-101/valid', transform=transform)
    # Get class names
    ...
    from models.caresnet18 import CAResNet18
    ...
    for epoch in range(50):
        ...
        if val_acc > max_acc:
            ...
            file_path = os.path.join(folder_path,
                                     'eca_resnet18_epoch_' + str(epoch) + '_acc_{0:.4f}'.format(val_acc) + '.pt')
