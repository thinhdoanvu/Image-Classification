...
# Khi them module thi sua 2 dong 10, 387
from nn.modules import (C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x, Classify, Concat, Conv, ConvTranspose, Detect, DWConv, DWConvTranspose2d, Ensemble, Focus, GhostBottleneck, GhostConv, Segment,

                        PositionalEmbedding, MyMSA, MyMLP, Alexnet, MyMHSA, SAM, CAM, CBAM, SEBlock, ECA, MyAdd, MyClassify, MyClass, Block1, Block21, Block31, Block41, Block51, Block22, Block32, Block42, Block52, Skip, 
                        MyMHSA_v2, MyESC, h_sigmoid, h_swish, CoordAtt, MyESCC, MyESC2, MyESC3, C_Attention, H_Attention, W_Attention, HWC
                        )
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
            ...
            args = [ch[f]]
        # For my modification -------------------------
        elif m in {CBAM, SEBlock, ECA, TCA, C_Attention, H_Attention, W_Attention}:
            c1 = args[0]
           
        elif m in {MyClassify, MyClass, Block1, Block21, Block31, Block41, Block51, Block22, Block32, Block42, Block52, Skip, 
                    MyMHSA, MyMHSA_v2, MyESC, CoordAtt, MyESCC, MyESC2, MyESC3, HWC
                }:
            c1 = args[0]
            c2 = args[1]
